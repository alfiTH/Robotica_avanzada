...
# constructor
#-----------------------------------------------------------------------
    def __init__(self, pin_en, pin_step=-1, pin_dir=-1, baudrate=115200, serialport="/dev/ttyUSB0", driver_address=0, no_uart=False, gpio_mode=GPIO.BCM, loglevel = None):
...
# init function
#-----------------------------------------------------------------------
    def init(self, pin_en, pin_step=-1, pin_dir=-1, baudrate=115200, serialport="/dev/ttyUSB0", driver_address=0, no_uart=False, gpio_mode=GPIO.BCM, loglevel = None):
